...
public class Interpreter {
	...
	public Interpreter(File scriptHandle, String prefix) throws IOException, ParseException {
		this(readFile(scriptHandle), prefix);
	}
	
	public Interpreter(String script, String prefix) throws IOException, ParseException {
